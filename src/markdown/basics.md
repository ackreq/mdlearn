...
گاهی لازم است به خط بعد بروید، بدون آنکه پاراگراف تازه‌ای ساخته شود. این کار در مارک‌دون با گذاشتن **دو یا چند فاصله در انتهای خط** و سپس فشردن کلید <kbd>Enter</kbd> انجام می‌شود:
